    ...
    <div class="upload">
      <el-form ref="form" label-width="80px">
        <div class="upload" style="margin:0 0 10px">
          <el-upload class="upload-demo" action :limit="1" :file-list="formFileList" :http-request="handleUploadForm"
  ...
  export default {
    ...
    methods: {
      ...
      beforeUploadForm(file) {
        ...
        const extension = testmsg === "jpg" || testmsg === "jpeg" || testmsg === "png" || testmsg === "JPGng" || testmsg === "png" || testmsg === "Vido" || testmsg === "mp3" || testmsg === "mp4";
        if (!extension) {
          this.$message({
