	...
	<div class="edit-container">
		...
		<footer>
			<div class="block">
				...
				<el-date-picker v-model="selectTime" value-format="yyyy-MM-dd"  align="right" type="date" placeholder="选择日期" :picker-options="pickerOptions">
				</el-date-picker>
			</div>
			<div class="btn-box">
