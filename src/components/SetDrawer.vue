<template>
  <div class="Drawer">
    ...
    <el-drawer title="设置问卷调查" :before-close="handleClose" :visible.sync="dialog" direction="ltr"
      ...
      <div class="demo-drawer__content">
        <el-form :model="form">
          ...
          <el-form-item label="选择日期" :label-width="formLabelWidth">
            <div class="block">
              <el-date-picker v-model="form.selectTime" type="datetimerange" align="left" size="large" unlink-panels
                format="yyyy 年 MM 月 dd 日 HH:mm:ss" value-format="yyyy-MM-dd HH:mm:ss" range-separator="至"
          ...
          <el-form-item label="问卷描述" class="desc">
            <el-input type="textarea" rows="5" style="text-indent: 6rem !important;" placeholder="请输入内容"
              v-model="textarea" maxlength="150" v-model.trim.trim="form.desc" show-word-limit></el-input>
              ...
              if (this.code == 0 || this.code == undefined) {
                ...
                UpdateQsSetting({
                  ...
                  if (res.data.code === 200) {
                    ...
                    // to do 新增加完成以后后端返回code 直接根据code跳转到新增问卷去
                    this.$router.push({
                      name: "qsList",
                      params: {
                        from: "/"
